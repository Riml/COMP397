...
var scenes;
(function (scenes) {
    var Home_Thunder = (function (_super) {
        __extends(Home_Thunder, _super);
        function Home_Thunder() {
            _super.call(this);
        }
        // PUBLIC FUNCTIONS
        Home_Thunder.prototype.start = function () {
            // Add objects to the scene
            console.log("Hunt scene started");
            // Create and add level description
            this._levelDescription = new objects.Label("Killed by a thunder!", "60px Consolar", "#000000", config.Screen.CENTER_X, config.Screen.CENTER_Y);
        ...
        Home_Thunder.prototype.update = function () {
            // Update objects
        };
        Home_Thunder.prototype._onBackButtonClick = function (event) {
    ...
    scenes.Home_Thunder = Home_Thunder;
})(scenes || (scenes = {}));
//# sourceMappingURL=home_thunder.js.map